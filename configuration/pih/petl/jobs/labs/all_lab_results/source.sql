...
drop temporary table if exists temporary_laborders_spec;
create temporary table temporary_laborders_spec
(
...
drop temporary table if exists temporary_labresults;
create temporary table temporary_labresults
(
  patient_id int(11),
  emr_id varchar(50),
  loc_registered varchar(255),
...
insert into temporary_laborders_spec (encounter_id,encounter_datetime,patient_id,emr_id)
...
update temporary_laborders_spec t
...
-- emr id location 
update temporary_laborders_spec ts 
...
insert into temporary_labresults (patient_id,emr_id,loc_registered, unknown_patient, gender, age_at_enc, department, commune, section, locality, street_landmark,order_number,orderable,specimen_collection_date, results_date, results_entry_date,test_concept_id,test, lab_id, LOINC,result_coded_answer,result_numeric_answer,result_text_answer)
...
res.value_numeric,
res.value_text
  from temporary_laborders_spec ts
