...
INSERT INTO temp_tb_smear_results (patient_id, encounter_id, test_related_to, test_type, date_created)
SELECT person_id, encounter_id, 'tb', 'smear', date_created FROM obs WHERE voided = 0 AND
...
# patient and encounter IDs
INSERT INTO temp_tb_culture_results (patient_id, encounter_id, test_related_to, test_type, date_created)
SELECT person_id, encounter_id, 'tb', 'culture', date_created FROM obs WHERE voided = 0 AND
...
# patient and encounter IDs
INSERT INTO temp_tb_genxpert_results (patient_id, encounter_id, test_related_to, test_type, date_created)
SELECT person_id, encounter_id, 'tb', 'genXpert', date_created FROM obs WHERE voided = 0 AND
...
# patient and encounter IDs
INSERT INTO temp_tb_skin_results (patient_id, encounter_id, test_related_to, test_type, date_created)
SELECT person_id, encounter_id, 'tb', 'skin test', date_created FROM obs WHERE voided = 0 AND
