...
*/
#				
DROP FUNCTION IF EXISTS obs_group_id_of_value_coded_from_temp;
#
CREATE FUNCTION obs_group_id_of_value_coded_from_temp(_encounterId int(11), _source varchar(50), _term varchar(255), _source1 varchar(50), _term1 varchar(255))
RETURNS int(11)
DETERMINISTIC
