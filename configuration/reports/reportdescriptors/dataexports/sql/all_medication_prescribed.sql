...
update temp_medication_orders tm join drug_order dgo on tm.order_id = dgo.order_id join drug d on d.concept_id = tm.concept_id
...
update temp_medication_orders tm set order_reason = concept_name(order_reason, 'en');
...
order_reason, 
order_comments
from temp_medication_orders order by order_date_activated, patient_id;
