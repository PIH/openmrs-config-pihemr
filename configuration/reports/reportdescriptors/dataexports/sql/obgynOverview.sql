...
(
    ...
    illicit_drug_name varchar(255),
    current_medications varchar(255),
    other_medication varchar(255),
    medical_history varchar(2000),
    specific_heart_disease varchar(255),
    specific_sti varchar(255),
    specific_surgery varchar(255),
    specific_trauma varchar(255),
    other_specific_history varchar(255),
