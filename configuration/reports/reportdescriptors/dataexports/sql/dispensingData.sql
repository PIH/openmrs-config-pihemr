...
INSERT INTO temp_dispensing_enc(encounter_id, patient_id, visitId,location_id, dispensedDatetime)
SELECT encounter_id, patient_id, visit_id, location_id, DATE(encounter_datetime) FROM encounter e WHERE voided = 0 AND encounter_type = @pharmacy_encounter
...
inner join temp_dispensing_enc t on t.encounter_id = o.encounter_id 
where o.voided = 0
and o.concept_id = concept_from_mapping('PIH','9070');
